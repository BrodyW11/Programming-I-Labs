public class Tester {
	...
	public static void testPart3() {
		...
		Door newDoor= new Door();
                ...
                CardLock labCardLock = new CardLock();
                newDoor.attachLock(labCardLock);
        
               SmartCard Brody_Sc = new SmartCard("Brody Walters");
               labCardLock.swipeCard(Brody_Sc);
               newDoor.openDoor();
        
               SmartCard staffSmartCard = new SmartCard("Kirk Martinez"); 
               staffSmartCard.setStaff(true);
               labCardLock.swipeCard(staffSmartCard);
               newDoor.openDoor();
	}
